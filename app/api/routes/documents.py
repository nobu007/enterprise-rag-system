...
async def ingest_documents(request: DocumentIngestRequest) -> DocumentIngestResponse:
    ...
    try:
        ...
        # Deliberate HTTP errors raised above (400/404) must not be
        # swallowed and re-wrapped as a 500 by the catch-all below.
        raise
...
async def upload_document(
    ...
    try:
        ...
        # Deliberate HTTP errors raised above (400/422) must not be
        # swallowed and re-wrapped as a 500 by the catch-all below.
        raise
    except Exception as e:
        raise HTTPException(
